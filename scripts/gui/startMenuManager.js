...
export default class StartMenu {
     ...
     */
    _createSubMenu(className, innerHTML, propertyName) {
        ...
        menuElement.style.display = 'none'; // Start hidden
        this[propertyName] = menuElement; // Assign to the specified class property
        ...
        const menuHTML = `
            <ul class="most-used-tools-items">
                <li class="most-used-tools-item" data-program-name="program1">
                    <img src="./assets/gui/start-menu/photoshop.webp" alt="Adobe Photoshop">
                    Adobe Photoshop
                </li>
                <li class="most-used-tools-item" data-program-name="program2">
                    <img src="./assets/gui/start-menu/premiere.webp" alt="Adobe Premiere Pro">
                    Adobe Premiere Pro
                </li>
                <li class="most-used-tools-item" data-program-name="program3">
                    <img src="./assets/gui/start-menu/illustrator.webp" alt="Adobe Illustrator">
                    Adobe Illustrator
                </li>
                <li class="most-used-tools-item" data-program-name="after-effects">
                    <img src="./assets/gui/start-menu/after-effects.webp" alt="Adobe After Effects">
                    Adobe After Effects
                </li>
                <li class="most-used-tools-item" data-program-name="indesign">
                    <img src="./assets/gui/start-menu/indesign.webp" alt="Adobe InDesign">
                    Adobe InDesign
                </li>
                <li class="most-used-tools-item" data-program-name="lightroom">
                    <img src="./assets/gui/start-menu/lightroom.webp" alt="Adobe Lightroom">
                    Adobe Lightroom
                </li>
                <li class="most-used-tools-item" data-program-name="program6">
                    <img src="./assets/gui/start-menu/blender.webp" alt="Blender">
                    Blender
                </li>
                <li class="most-used-tools-item" data-program-name="program5">
                    <img src="./assets/gui/start-menu/vscode.webp" alt="VS Code">
                    VS Code
                </li>
                <li class="most-used-tools-item" data-program-name="figma">
                    <img src="./assets/gui/start-menu/figma.webp" alt="Figma">
                    Figma
                </li>
            </ul>
        `;
        ...
        const menuHTML = `
            <ul class="ai-tools-items">
                <li class="ai-tools-item" data-program-name="chatgpt">
                    <img src="./assets/gui/start-menu/chatgpt.webp" alt="ChatGPT">
                    ChatGPT
                </li>
                <li class="ai-tools-item" data-program-name="sora">
                    <img src="./assets/gui/start-menu/sora.webp" alt="Sora">
                    Sora
                </li>
                <li class="ai-tools-item" data-program-name="git-copilot">
                    <img src="./assets/gui/start-menu/git-copilot.webp" alt="Git Copilot">
                    Git Copilot
                </li>
                <li class="ai-tools-item" data-program-name="cursor">
                    <img src="./assets/gui/start-menu/cursor.webp" alt="Cursor">
                    Cursor
                </li>
            </ul>
        `;
            ...
            <div class="start-menu-middle">
                <div class="middle-section middle-left">
                    <ul class="menu-items">
                        ...
                        <li class="menu-item" id="menu-messenger" data-action="open-program" data-program-name="msn-messenger">
                            <img src="./assets/gui/start-menu/msn-messenger.webp" alt="MSN Messenger">
                            <div class="item-content">
                                <span class="item-title">MSN Messenger</span>
                            </div>
                        </li>
